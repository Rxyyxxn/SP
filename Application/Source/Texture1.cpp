...
{	
	...
	meshList[GEO_QUAD]->textureID = LoadTGA("Image//Capture.tga");
...
void Texture1::Update(double dt)
{
	float LSPEED=10.f;
...
void Texture1::Render()
{
		...
		////to do: transformation code here. Middle sphere
...
void Texture1::RenderMesh(Mesh* mesh, bool enableLight)
{
