...
void Practical10::Update(double dt)
{
	float LSPEED=10.f;
...
void Practical10::Render()
{
		...
		modelStack.Translate(0, 100, -150);
		...
		modelStack.PushMatrix();
		modelStack.Translate(10, 4, -5);
		modelStack.Scale(0.5, 0.5, 0.5);
		RenderMesh(meshList[GEO_MODEL1], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
		modelStack.Translate(11, 1, 4);
		modelStack.Scale(0.5, 0.5, 0.5);
		RenderMesh(meshList[GEO_MODEL2], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
		modelStack.Translate(10, 1, 4);
...
void Practical10::RenderMesh(Mesh* mesh, bool enableLight)
{
