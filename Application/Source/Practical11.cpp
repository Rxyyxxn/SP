...
void Practical11::Update(double dt)
{
...
void Practical11::RenderMesh(Mesh* mesh, bool enableLight)
{
...
void Practical11::RenderText(Mesh* mesh, std::string text, Color color)
{
...
void Practical11::RenderTextOnScreen(Mesh* mesh, std::string text,Color color, float size, float x, float y)
{
	if (!mesh || mesh->textureID <= 0) //Proper error check
		return;
	glDisable(GL_DEPTH_TEST); //uncomment for RenderTextOnScreen
